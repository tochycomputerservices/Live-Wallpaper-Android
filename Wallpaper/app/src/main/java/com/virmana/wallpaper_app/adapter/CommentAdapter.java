...
import com.virmana.wallpaper_app.ui.activities.SupportActivity;
import com.virmana.wallpaper_app.ui.activities.UserActivity;
...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.CommentHolder> {
    ...
    public void onBindViewHolder(CommentHolder holder,final int position) {
        ...
        holder.image_view_report.setOnClickListener(view -> {
            PopupMenu popup = new PopupMenu(activity,  holder.image_view_report);
